...
add_impl_pub_fns!(PARAMS, must_get_contract_id, get_contract_id, exists_contract_id, ScContractId);
...
add_impl_adder_pub_fns!(add_contract_id, get_contract_id, &ScContractId);
